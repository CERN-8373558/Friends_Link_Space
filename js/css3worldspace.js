/* ============================================================
 * css3worldspace.js —— CSS3D 世界 / 相机矩阵 (对应原站 css3worldspace.js)
 * ============================================================ */

var screenWidth, screenHeight, screenWhalf, screenHhalf;
...
function initCSS3D() {
  ...
  divCSSWorld = cssWorldEl;
  divCSSCamera = cssCameraEl;
...
function setCSSWorld() {
  ...
  divCSSWorld.style.perspective = fovValue + 'px';
  divCSSWorld.style.perspectiveOrigin = '50% 50%';
}
...
function setCSSCamera(camera, fovValue) {
  ...
  divCSSCamera.style.transform = cameraStyle;
}
...
function setDivPosition(cssObject, glObject, scale) {
  ...
  cssObject.style.transformOrigin = '0% 0%';
  cssObject.style.transform = transformation;
}
